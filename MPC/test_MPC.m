...
%     W_rec(:,k) = .9*W_demand(:,k);
    ...
    objective = objective + W_pull(1,k)*phi_water + (.43*H - 50) % P_pump(1,k)*phi_e(k);
...
figure
plot(1:k,value(W_pull(1,1:k)),'LineWidth',2)
